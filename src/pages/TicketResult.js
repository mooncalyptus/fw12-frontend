            ...
            <div className="bg-[#E5E5E5]">
                <div className="flex justify-center content-center">
                    <div className="bg-white mt-[72px] mb-24">
                        <div className="pt-14 text-center">Proof Payment</div>
                        <div className="flex border-2 border-[#AAAAAA] ml-[72px] mr-[70px] mb-32 rounded-lg">
                            ...
                            <div>
                                <div className="flex gap-x-60 bg-[#8EC3B0]">
                                    ...
                                    <div className="pt-[18px]">Admit One</div>
                                </div>
                                <div className="ml-14">
